...
<!---------------------------------------------------------------------------------------------------------->
		...
		%>
           ...
           <form  method="POST" action="UpdationUserServlet"  role="form">
                                        
                         
                     <div class="form-group">
                           <label>User ID</label>
                              <input  type="text" name="sl_no" disabled="disabled"  class="form-control"  value="<%=User.getSl_no()%>"  >
                    </div>
                         
                                        
                    <div class="form-group">
                           <label>User name</label>
                              <input  type="text" name="user_name"   class="form-control"  value="<%=User.getUser_name()%>"  >
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                             <label>Mobile No</label>
                              <input type="text" name="mobile"   class="form-control"  value="<%=User.getMobile()%>"  >
                    </div>
                    ...
                    <div class="form-group">
                             <label>Member Type</label>
                                <input type="text" name="memberType"   class="form-control"  value="<%=User.getMemberType()%>" >
                    </div>
        ...
        <input type="hidden" name="sl_no"  value="<%=User.getSl_no()%>" /> 
       	...
       	<input type="submit" value="update user" class="btn btn-gradient-primary mr-2" /></td>
      </tr>
...
<!---------------------------------------------------------------------------------------------------------->
    ...
    <form method="POST" action="DeletionUserServlet">
    <table>
      <tr>
        <td colspan="2"><input type="hidden" name="sl_no" value="<%=User.getSl_no()%>" class="btn btn-light" />
        				<input type="submit"
						value="Delete User" class="btn btn-light"/>
